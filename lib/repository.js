...
function fetchRoomTimers(roomId) {
  return loadPersistedTimers()
    .then(function(timers){return timers.filter(function(timer){
      var result = timer.args[1] === roomId;
      console.log('filtering', result, roomId, timer);
      return result;
    })});
}
...
module.exports = {
  ...
  fetchRoomTimers: fetchRoomTimers 
};